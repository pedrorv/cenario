        ...
        for (var movie in dataCircles[year][month]) {
          movies.append("circle")
            ...
            .attr("cx", function(d, i) {
              return (visConfig.width - visConfig.wMargin) - (425 * dataCircles[year][month][movie]["Público"]/maxDataCircles);
            })
            .attr("cy", function(d, i) {
              var monthValue = parseInt(month);
              return visConfig.hMargin + ((monthValue - 1) * visConfig.barSpacing) + (visConfig.years[year] * visConfig.barSpacing * visConfig.barSpacing) + (visConfig.years[year] * visConfig.barMargin);
            })
